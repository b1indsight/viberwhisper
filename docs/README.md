...
| [35-silent-audio-hallucination-suppression.md](plan/35-silent-audio-hallucination-suppression.md) | Proposed | Suppress effectively silent WAV chunks before STT upload and preserve empty no-output behavior |
