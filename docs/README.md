...
| [48-hotkey-simplification.md](plan/48-hotkey-simplification.md) | In progress | Simplify callback state and paired hotkey bindings, and share one canonical-name/alias catalog |
