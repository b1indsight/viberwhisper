...
| [39-release-notes-automation.md](plan/39-release-notes-automation.md) | Proposed | Prepend validated distribution guidance to automatically generated Release Notes |
