...
| [07-llm-transcription.md](plan/07-llm-transcription.md) | LLM transcription support: backend abstraction, `LlmTranscriber` design, config evolution, and phased rollout |
