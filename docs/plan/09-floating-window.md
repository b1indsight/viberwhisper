...
- `windows_impl.rs` — Native Win32 popup window with matching click, drag, always-on-top, and recording-state behavior
...
4. Create platform implementations and retain `stub.rs` as the no-op fallback for unsupported platforms
